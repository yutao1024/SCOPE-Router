...
def main():
    ...
    parser.add_argument("--loss_type", default="softmax", choices=["softmax", "siglip_relevance"],
    ...
    parser.add_argument("--num_clusters", type=int, default=5,
                       help="Compatibility tag for sample-sample variants")
    ...
    router = ZooterRouter(
        ...
        train_lambda=train_lambda if args.loss_type == "siglip_relevance" else (0.0 if is_hard_label else train_lambda),
